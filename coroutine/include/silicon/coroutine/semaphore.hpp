...
extern COROUTINE_EXPORT std::string semaphore_acquire_result_acquired;
extern COROUTINE_EXPORT std::string semaphore_acquire_result_shutdown;
extern COROUTINE_EXPORT std::string semaphore_acquire_result_unknown;
