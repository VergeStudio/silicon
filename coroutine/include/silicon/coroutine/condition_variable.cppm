...
class condition_variable {
  ...
  private:
    ...
    struct awaiter_base {
        ...
        virtual auto on_notify() -> silicon::coroutine::task<notify_status_t> = 0;
    };
    ...
    struct awaiter: public awaiter_base {
        ...
        auto on_notify() -> silicon::coroutine::task<notify_status_t> override;
    };
    ...
    struct awaiter_with_wait: public awaiter_base {
         ...
         * @return silicon::coroutine::task<void>
         */
        auto make_on_notify_callback_task(controller_data &data) -> silicon::coroutine::task<void> {
         ...
         * @return silicon::coroutine::task<void>
         */
        auto make_timeout_task(controller_data &data) -> silicon::coroutine::task<void> {
         ...
         *
         * @return silicon::coroutine::detail::task_self_deleting This task is self deleting since it has an indeterminate lifetime.
         */
        auto make_controller_task() -> silicon::coroutine::detail::task_self_deleting {
        ...
        auto on_notify() -> silicon::coroutine::task<notify_status_t> override { std::unreachable(); }
  ...
  public:
     ...
     */
    auto notify_one() -> silicon::coroutine::task<void>;
     ...
     */
    auto notify_all() -> silicon::coroutine::task<void>;
