...
static void
cls_struct_64byte_gn(sffi_cif* cif __UNUSED__, void* resp, void** args,
...
int main (void)
{
  ...
  CHECK(sffi_prep_closure_loc(pcl, &cif, cls_struct_64byte_gn, NULL, code) == SFFI_OK);
