...
int main (void)
{
  ...
  cl_arg_types[1] = &sffi_type_uint64;
  cl_arg_types[2] = &sffi_type_uint64;
  cl_arg_types[3] = &sffi_type_uint64;
  cl_arg_types[4] = &sffi_type_sint;
  ...
  cl_arg_types[9] = &sffi_type_double;
  ...
  cl_arg_types[14] = &sffi_type_double;
  cl_arg_types[15] = &sffi_type_double;
