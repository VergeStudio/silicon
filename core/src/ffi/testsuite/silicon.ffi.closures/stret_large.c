...
static void
cls_struct_108byte_gn(sffi_cif* cif __UNUSED__, void* resp, void** args, void* userdata __UNUSED__)
{
...
int main (void)
{
	...
	void* args_dbl[5];
	sffi_type* cls_struct_fields[15];
	...
	cls_struct_fields[2] = &sffi_type_double;
	cls_struct_fields[3] = &sffi_type_double;
	cls_struct_fields[4] = &sffi_type_double;
	cls_struct_fields[5] = &sffi_type_double;
	cls_struct_fields[6] = &sffi_type_double;
	cls_struct_fields[7] = &sffi_type_double;
	cls_struct_fields[8] = &sffi_type_double;
	cls_struct_fields[9] = &sffi_type_double;
	cls_struct_fields[10] = &sffi_type_double;
	cls_struct_fields[11] = &sffi_type_double;
	cls_struct_fields[12] = &sffi_type_double;
	cls_struct_fields[13] = &sffi_type_sint32;
	...
	CHECK(sffi_prep_cif(&cif, SFFI_DEFAULT_ABI, 4, &cls_struct_type,
	...
	sffi_call(&cif, SFFI_FN(cls_struct_108byte_fn), &res_dbl, args_dbl);
	...
	CHECK(sffi_prep_closure_loc(pcl, &cif, cls_struct_108byte_gn, NULL, code) == SFFI_OK);
