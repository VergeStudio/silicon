...
static void
cls_struct_3float_gn(sffi_cif *cif __UNUSED__, void* resp, void **args,
...
int main (void)
{
  ...
  cls_struct_fields[0] = &sffi_type_float;
  cls_struct_fields[1] = &sffi_type_float;
  cls_struct_fields[2] = &sffi_type_float;
  ...
  CHECK(sffi_prep_closure_loc(pcl, &cif, cls_struct_3float_gn, NULL, code) ==
	SFFI_OK);
