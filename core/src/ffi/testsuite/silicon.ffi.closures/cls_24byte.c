...
static void
cls_struct_24byte_gn(sffi_cif* cif __UNUSED__, void* resp, void** args,
...
int main (void)
{
  ...
  cls_struct_fields[3] = &sffi_type_float;
  ...
  CHECK(sffi_prep_closure_loc(pcl, &cif, cls_struct_24byte_gn, NULL, code) == SFFI_OK);
