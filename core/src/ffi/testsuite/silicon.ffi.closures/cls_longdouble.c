...
static void
cls_ldouble_gn(sffi_cif* cif __UNUSED__, void* resp, 
...
int main(void)
{
	...
	arg_types[0] = &sffi_type_longdouble;
	arg_types[1] = &sffi_type_longdouble;
	arg_types[2] = &sffi_type_longdouble;
	arg_types[3] = &sffi_type_longdouble;
	arg_types[4] = &sffi_type_longdouble;
	arg_types[5] = &sffi_type_longdouble;
	arg_types[6] = &sffi_type_longdouble;
	arg_types[7] = &sffi_type_longdouble;
	arg_types[8] = NULL;

	CHECK(sffi_prep_cif(&cif, SFFI_DEFAULT_ABI, 8, &sffi_type_longdouble,
		arg_types) == SFFI_OK);
