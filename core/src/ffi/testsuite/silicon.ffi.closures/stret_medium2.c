...
static void
cls_struct_72byte_gn(sffi_cif* cif __UNUSED__, void* resp, void** args, void* userdata __UNUSED__)
{
...
int main (void)
{
	...
	void* args_dbl[5];
	sffi_type* cls_struct_fields[10];
	...
	cls_struct_fields[8] = &sffi_type_sint64;
