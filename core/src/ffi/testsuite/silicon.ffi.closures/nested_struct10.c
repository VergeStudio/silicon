...
int main (void)
{
  ...
  sffi_type* cls_struct_fields1[4];
  sffi_type* cls_struct_fields2[3];
  sffi_type cls_struct_type, cls_struct_type1, cls_struct_type2;
  sffi_type* dbl_arg_types[4];
  ...
  cls_struct_type2.type = SFFI_TYPE_STRUCT;
  cls_struct_type2.elements = cls_struct_fields2;

  cls_struct_fields[0] = &sffi_type_uint64;
  cls_struct_fields[1] = &sffi_type_uchar;
  cls_struct_fields[2] = NULL;

  cls_struct_fields1[0] = &sffi_type_uchar;
  cls_struct_fields1[1] = &cls_struct_type;
  cls_struct_fields1[2] = &sffi_type_uint;
  cls_struct_fields1[3] = NULL;

  cls_struct_fields2[0] = &sffi_type_uint64;
  ...
  CHECK(sffi_prep_cif(&cif, SFFI_DEFAULT_ABI, 3, &cls_struct_type1,
