...
int main (void)
{
  ...
  point_type_elements[0] = &sffi_type_slong;
  point_type_elements[1] = &sffi_type_slong;
  ...
  rect_type_elements[0] = &sffi_type_slong;
  rect_type_elements[1] = &sffi_type_slong;
  rect_type_elements[2] = &sffi_type_slong;
  rect_type_elements[3] = &sffi_type_slong;
