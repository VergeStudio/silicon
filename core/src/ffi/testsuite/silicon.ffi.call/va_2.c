...
main (void)
{
  ...
  arg_types[2] = &l_type;
  arg_types[3] = &s_type;
  arg_types[4] = &sffi_type_uint;
  arg_types[5] = &sffi_type_sint;
  arg_types[6] = &sffi_type_uint;
  arg_types[7] = &sffi_type_sint;
  ...
  CHECK(sffi_prep_cif_var(&cif, SFFI_DEFAULT_ABI, 1, 14, &sffi_type_sint, arg_types) == SFFI_OK);
