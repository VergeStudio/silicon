...
silicon::scheduler::task<connection_status> client::handshake(std::chrono::milliseconds timeout) {
...
silicon::scheduler::task<void> client::tls_shutdown_and_free(std::chrono::milliseconds timeout) {
