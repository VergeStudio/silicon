...
export module silicon.json:detail.input.input_adapters;
...
export class file_input_adapter {
  public:
...
export template<typename BaseInputAdapter, size_t T>
struct wide_string_input_helper;

export template<typename BaseInputAdapter>
...
export template<typename IteratorType, typename Enable = void>
...
export template<typename ContainerType, typename Enable = void>
...
export inline file_input_adapter input_adapter(std::FILE *file) {
    return file_input_adapter(file);
}

export inline input_stream_adapter input_adapter(std::istream &stream) {
