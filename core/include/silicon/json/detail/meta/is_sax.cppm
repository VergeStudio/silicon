...
export module silicon.json:detail.meta.is_sax;
...
export template<typename T, typename Integer>
using number_integer_function_t =
        decltype(std::declval<T &>().number_integer(std::declval<Integer>()));

export template<typename T, typename Unsigned>
using number_unsigned_function_t =
        decltype(std::declval<T &>().number_unsigned(std::declval<Unsigned>()));

export template<typename T, typename Float, typename String>
using number_float_function_t = decltype(std::declval<T &>().number_float(
        std::declval<Float>(),
        std::declval<const String &>()
));

export template<typename T, typename String>
using string_function_t =
        decltype(std::declval<T &>().string(std::declval<String &>()));

export template<typename T, typename Binary>
...
export template<typename T, typename Exception>
...
export template<typename SAX, typename BasicJsonType>
struct is_sax {
  private:
