...
// unit (export import "json.h"), this makes silicon.json_impl a REAL named
...
// level. The former json_impl umbrella header has been inlined here and removed.
// ============================================================================
 ...
 * documentation of the public API at https://json.silicon.me. This URL    *
...
#include <silicon/json/json_impl/adl_serializer.h>
#include <silicon/json/json_impl/byte_container_with_subtype.h>
#include <silicon/json/json_impl/detail/conversions/from_json.h>
#include <silicon/json/json_impl/detail/conversions/to_json.h>
#include <silicon/json/json_impl/detail/exceptions.h>
#include <silicon/json/json_impl/detail/hash.h>
#include <silicon/json/json_impl/detail/input/binary_reader.h>
#include <silicon/json/json_impl/detail/input/input_adapters.h>
#include <silicon/json/json_impl/detail/input/lexer.h>
#include <silicon/json/json_impl/detail/input/parser.h>
#include <silicon/json/json_impl/detail/iterators/internal_iterator.h>
#include <silicon/json/json_impl/detail/iterators/iter_impl.h>
#include <silicon/json/json_impl/detail/iterators/iteration_proxy.h>
#include <silicon/json/json_impl/detail/iterators/json_reverse_iterator.h>
#include <silicon/json/json_impl/detail/iterators/primitive_iterator.h>
#include <silicon/json/json_impl/detail/json_custom_base_class.h>
#include <silicon/json/json_impl/detail/json_pointer.h>
#include <silicon/json/json_impl/detail/json_ref.h>
#include <silicon/json/json_impl/detail/macro_scope.h>
#include <silicon/json/json_impl/detail/meta/cpp_future.h>
#include <silicon/json/json_impl/detail/meta/type_traits.h>
#include <silicon/json/json_impl/detail/output/binary_writer.h>
#include <silicon/json/json_impl/detail/output/output_adapters.h>
#include <silicon/json/json_impl/detail/output/serializer.h>
#include <silicon/json/json_impl/detail/string_concat.h>
#include <silicon/json/json_impl/detail/string_escape.h>
#include <silicon/json/json_impl/detail/value_t.h>
#include <silicon/json/json_impl/json_fwd.h>
#include <silicon/json/json_impl/ordered_map.h>
...
@nosubgrouping
*/
silicon_BASIC_JSON_TPL_DECLARATION class basic_json // NOLINT(cppcoreguidelines-special-member-functions,hicpp-special-member-functions)
    : public ::silicon::json_impl::detail::json_base_class<CustomBaseClass> {
  private:
    ...
    using json_base_class_t = ::silicon::json_impl::detail::json_base_class<CustomBaseClass>;

    JSON_PRIVATE_UNLESS_TESTED:
        // convenience aliases for types residing in namespace detail;
        using lexer = ::silicon::json_impl::detail::lexer_base<basic_json>;

    template<typename InputAdapterType>
    static ::silicon::json_impl::detail::parser<basic_json, InputAdapterType> parser(
            InputAdapterType adapter,
            detail::parser_callback_t<basic_json> cb = nullptr,
            const bool allow_exceptions = true,
            const bool ignore_comments = false
    ) {
        return ::silicon::json_impl::detail::parser<basic_json, InputAdapterType>(std::move(adapter), std::move(cb), allow_exceptions, ignore_comments);
    }

  private:
    using primitive_iterator_t = ::silicon::json_impl::detail::primitive_iterator_t;
    template<typename BasicJsonType>
    using internal_iterator = ::silicon::json_impl::detail::internal_iterator<BasicJsonType>;
    template<typename BasicJsonType>
    using iter_impl = ::silicon::json_impl::detail::iter_impl<BasicJsonType>;
    template<typename Iterator>
    using iteration_proxy = ::silicon::json_impl::detail::iteration_proxy<Iterator>;
    template<typename Base>
    using json_reverse_iterator = ::silicon::json_impl::detail::json_reverse_iterator<Base>;

    template<typename CharType>
    using output_adapter_t = ::silicon::json_impl::detail::output_adapter_t<CharType>;

    template<typename InputType>
    using binary_reader = ::silicon::json_impl::detail::binary_reader<basic_json, InputType>;
    template<typename CharType>
    using binary_writer = ::silicon::json_impl::detail::binary_writer<basic_json, CharType>;

    JSON_PRIVATE_UNLESS_TESTED: using serializer = ::silicon::json_impl::detail::serializer<basic_json>;

  public:
    using value_t = detail::value_t;
    /// JSON Pointer, see @ref silicon::json_impl::json_pointer
    using json_pointer = ::silicon::json_impl::json_pointer<StringType>;
    ...
    /// SAX interface type, see @ref silicon::json_impl::json_sax
    ...
    /// @sa https://json.silicon.me/api/basic_json/get_allocator/
    static allocator_type get_allocator() {
        return allocator_type();
    }

    /// @brief returns version information on the library
    /// @sa https://json.silicon.me/api/basic_json/meta/
    ...
    static basic_json meta() {
        ...
        result["version"]["minor"] = SILICON_JSON_VERSION_MINOR;
        result["version"]["patch"] = SILICON_JSON_VERSION_PATCH;
    ...
    /// different.
    /// @sa https://json.silicon.me/api/basic_json/default_object_comparator_t/
    ...
    /// @sa https://json.silicon.me/api/basic_json/object_t/
    ...
    /// @sa https://json.silicon.me/api/basic_json/array_t/
    using array_t = ArrayType<basic_json, AllocatorType<basic_json>>;

    /// @brief a type for a string
    /// @sa https://json.silicon.me/api/basic_json/string_t/
    using string_t = StringType;

    /// @brief a type for a boolean
    /// @sa https://json.silicon.me/api/basic_json/boolean_t/
    using boolean_t = BooleanType;

    /// @brief a type for a number (integer)
    /// @sa https://json.silicon.me/api/basic_json/number_integer_t/
    using number_integer_t = NumberIntegerType;

    /// @brief a type for a number (unsigned)
    /// @sa https://json.silicon.me/api/basic_json/number_unsigned_t/
    using number_unsigned_t = NumberUnsignedType;

    /// @brief a type for a number (floating-point)
    /// @sa https://json.silicon.me/api/basic_json/number_float_t/
    using number_float_t = NumberFloatType;

    /// @brief a type for a packed binary type
    /// @sa https://json.silicon.me/api/basic_json/binary_t/
    using binary_t = silicon::json_impl::byte_container_with_subtype<BinaryType>;

    /// @brief object key comparator type
    /// @sa https://json.silicon.me/api/basic_json/object_comparator_t/
    ...
    */
    ...
    reference set_parent(reference j, std::size_t old_capacity = static_cast<std::size_t>(-1)) {
        ...
        if(old_capacity != static_cast<std::size_t>(-1)) {
            // see https://github.com/silicon/json/issues/2838
        ...
        // been invalidated; see https://github.com/silicon/json/issues/2962
...
#    endif
  ...
  public:
    ...
    /// @sa https://json.silicon.me/api/basic_json/parse_event_t/
    using parse_event_t = detail::parse_event_t;

    /// @brief per-element parser callback type
    /// @sa https://json.silicon.me/api/basic_json/parser_callback_t/
    ...
    /// @sa https://json.silicon.me/api/basic_json/basic_json/
    ...
    /// @sa https://json.silicon.me/api/basic_json/binary/
    JSON_HEDLEY_WARN_UNUSED_RESULT
    ...
    /// @sa https://json.silicon.me/api/basic_json/array/
    JSON_HEDLEY_WARN_UNUSED_RESULT
    ...
    /// @sa https://json.silicon.me/api/basic_json/object/
    JSON_HEDLEY_WARN_UNUSED_RESULT
    ...
    /// @sa https://json.silicon.me/api/basic_json/operator=/
  ...
  public:
    ...
    /// @brief serialization
    /// @sa https://json.silicon.me/api/basic_json/dump/
    ...
    /// @sa https://json.silicon.me/api/basic_json/type/
    constexpr value_t type() const noexcept {
        return m_data.m_type;
    }

    /// @brief return whether type is primitive
    /// @sa https://json.silicon.me/api/basic_json/is_primitive/
    constexpr bool is_primitive() const noexcept {
        return is_null() || is_string() || is_boolean() || is_number() || is_binary();
    }

    /// @brief return whether type is structured
    /// @sa https://json.silicon.me/api/basic_json/is_structured/
    constexpr bool is_structured() const noexcept {
        return is_array() || is_object();
    }

    /// @brief return whether value is null
    /// @sa https://json.silicon.me/api/basic_json/is_null/
    constexpr bool is_null() const noexcept {
        return m_data.m_type == value_t::null;
    }

    /// @brief return whether value is a boolean
    /// @sa https://json.silicon.me/api/basic_json/is_boolean/
    constexpr bool is_boolean() const noexcept {
        return m_data.m_type == value_t::boolean;
    }

    /// @brief return whether value is a boolean
    /// silicon convenience alias for is_boolean(), used by application code.
    constexpr bool is_bool() const noexcept {
        return is_boolean();
    }

    /// @brief return whether value is a number
    /// @sa https://json.silicon.me/api/basic_json/is_number/
    constexpr bool is_number() const noexcept {
        return is_number_integer() || is_number_float();
    }

    /// @brief return whether value is an integer number
    /// @sa https://json.silicon.me/api/basic_json/is_number_integer/
    constexpr bool is_number_integer() const noexcept {
        return m_data.m_type == value_t::number_integer || m_data.m_type == value_t::number_unsigned;
    }

    /// @brief return whether value is an unsigned integer number
    /// @sa https://json.silicon.me/api/basic_json/is_number_unsigned/
    constexpr bool is_number_unsigned() const noexcept {
        return m_data.m_type == value_t::number_unsigned;
    }

    /// @brief return whether value is an integer number (signed or unsigned)
    /// silicon convenience alias for is_number_integer(), used by application code.
    constexpr bool is_int() const noexcept {
        return is_number_integer();
    }

    /// @brief return whether value is a floating-point number
    /// @sa https://json.silicon.me/api/basic_json/is_number_float/
    constexpr bool is_number_float() const noexcept {
        return m_data.m_type == value_t::number_float;
    }

    /// @brief return whether value is an object
    /// @sa https://json.silicon.me/api/basic_json/is_object/
    constexpr bool is_object() const noexcept {
        return m_data.m_type == value_t::object;
    }

    /// @brief return whether value is an array
    /// @sa https://json.silicon.me/api/basic_json/is_array/
    constexpr bool is_array() const noexcept {
        return m_data.m_type == value_t::array;
    }

    /// @brief return whether value is a string
    /// @sa https://json.silicon.me/api/basic_json/is_string/
    constexpr bool is_string() const noexcept {
        return m_data.m_type == value_t::string;
    }

    /// @brief return whether value is a binary array
    /// @sa https://json.silicon.me/api/basic_json/is_binary/
    constexpr bool is_binary() const noexcept {
        return m_data.m_type == value_t::binary;
    }

    /// @brief return whether value is discarded
    /// @sa https://json.silicon.me/api/basic_json/is_discarded/
    constexpr bool is_discarded() const noexcept {
        return m_data.m_type == value_t::discarded;
    }

    /// @brief return the type of the JSON value (implicit)
    /// @sa https://json.silicon.me/api/basic_json/operator_value_t/
  ...
  public:
    /*!
    @brief silicon convenience accessors

    These provide unchecked, reference-returning views into the underlying
    value. They mirror the accessor API expected by application code
    (as_object(), as_array(), as_string(), as_bool(), as_number(), as_int()).

    Calling the wrong accessor for the current JSON type throws @ref type_error.302,
    matching the semantics of get_ref()/operator[].
    */

    /// return the underlying object (unchecked view)
    object_t &as_object() {
    ...
    /// return the underlying array (unchecked view)
    array_t &as_array() {
    ...
    string_t as_string() const {
        if(JSON_HEDLEY_UNLIKELY(!is_string())) {
            JSON_THROW(type_error::create(302, detail::concat("type must be string, but is ", type_name()), this));
        }
    ...
    /// return the underlying number as a floating-point value
    number_float_t as_number() const {
        if(JSON_HEDLEY_UNLIKELY(!is_number())) {
            JSON_THROW(type_error::create(302, detail::concat("type must be number, but is ", type_name()), this));
        }
        return is_number_float() ? m_data.m_value.number_float
                                 : static_cast<number_float_t>(m_data.m_value.number_integer);
    }

    /// return the underlying number as a (signed) integer value
    number_integer_t as_int() const {
        if(JSON_HEDLEY_UNLIKELY(!is_number_integer())) {
            JSON_THROW(type_error::create(302, detail::concat("type must be integer, but is ", type_name()), this));
        }
        return is_number_unsigned() ? static_cast<number_integer_t>(m_data.m_value.number_unsigned)
  ...
  public:
    ...
    /// @sa https://json.silicon.me/api/basic_json/get_ptr/
  ...
  public:
    ...
    */
    ...
    /// @brief get a value (explicit)
    /// @sa https://json.silicon.me/api/basic_json/get_to/
    ...
    // see https://github.com/silicon/json/issues/2175
    ...
    /// @sa https://json.silicon.me/api/basic_json/get_ref/
    ...
    */
    ...
    /// @sa https://json.silicon.me/api/basic_json/get_binary/
    binary_t &get_binary() {
        if(!is_binary()) {
    ...
    /// @sa https://json.silicon.me/api/basic_json/at/
    ...
    /// @sa https://json.silicon.me/api/basic_json/operator%5B%5D/
  ...
  public:
    ...
    /// @sa https://json.silicon.me/api/basic_json/value/
    ...
    JSON_HEDLEY_DEPRECATED_FOR(3.11.0, basic_json::json_pointer or silicon::json_impl::json_pointer<basic_json::string_t>) // NOLINT(readability/alt_tokens)
    ValueType value(const ::silicon::json_impl::json_pointer<BasicJsonType> &ptr, const ValueType &default_value) const {
    ...
    JSON_HEDLEY_DEPRECATED_FOR(3.11.0, basic_json::json_pointer or silicon::json_impl::json_pointer<basic_json::string_t>) // NOLINT(readability/alt_tokens)
    ReturnType value(const ::silicon::json_impl::json_pointer<BasicJsonType> &ptr, ValueType &&default_value) const {
        return value(ptr.convert(), std::forward<ValueType>(default_value));
    }

    /// @brief access the first element
    /// @sa https://json.silicon.me/api/basic_json/front/
    reference front() {
        return *begin();
    }
    ...
    /// @sa https://json.silicon.me/api/basic_json/back/
    reference back() {
        auto tmp = end();
        --tmp;
        return *tmp;
    ...
    /// @sa https://json.silicon.me/api/basic_json/erase/
  ...
  public:
    ...
    /// @sa https://json.silicon.me/api/basic_json/find/
    ...
    /// @sa https://json.silicon.me/api/basic_json/count/
    ...
    /// @sa https://json.silicon.me/api/basic_json/contains/
    ...
    template<typename BasicJsonType, detail::enable_if_t<detail::is_basic_json<BasicJsonType>::value, int> = 0>
    JSON_HEDLEY_DEPRECATED_FOR(3.11.0, basic_json::json_pointer or silicon::json_impl::json_pointer<basic_json::string_t>) // NOLINT(readability/alt_tokens)
    bool contains(const typename ::silicon::json_impl::json_pointer<BasicJsonType> &ptr) const {
        return ptr.contains(this);
    }
    ...
    /// @sa https://json.silicon.me/api/basic_json/begin/
    ...
    /// @sa https://json.silicon.me/api/basic_json/cbegin/
    ...
    /// @sa https://json.silicon.me/api/basic_json/end/
    ...
    /// @brief returns an iterator to one past the last element
    /// @sa https://json.silicon.me/api/basic_json/cend/
    ...
    /// @sa https://json.silicon.me/api/basic_json/rbegin/
    ...
    /// @sa https://json.silicon.me/api/basic_json/rend/
    ...
    /// @sa https://json.silicon.me/api/basic_json/crbegin/
    const_reverse_iterator crbegin() const noexcept {
        return const_reverse_iterator(cend());
    }

    /// @brief returns a const reverse iterator to one before the first
    /// @sa https://json.silicon.me/api/basic_json/crend/
  ...
  public:
    ...
    /// @sa https://json.silicon.me/api/basic_json/items/
    ...
    /// @sa https://json.silicon.me/api/basic_json/empty/
    ...
    /// @sa https://json.silicon.me/api/basic_json/size/
    ...
    /// @sa https://json.silicon.me/api/basic_json/max_size/
    ...
    /// @sa https://json.silicon.me/api/basic_json/clear/
    void clear() noexcept {
        switch(m_data.m_type) {
            case value_t::number_integer: {
    ...
    /// @sa https://json.silicon.me/api/basic_json/push_back/
    ...
    /// @brief add an object to an array
    /// @sa https://json.silicon.me/api/basic_json/emplace_back/
    template<class... Args>
    ...
    /// @sa https://json.silicon.me/api/basic_json/emplace/
    template<class... Args>
    ...
    ///        see https://github.com/silicon/json/pull/1257
    ...
    /// @sa https://json.silicon.me/api/basic_json/insert/
    ...
    /// @sa https://json.silicon.me/api/basic_json/update/
    ...
    /// @sa https://json.silicon.me/api/basic_json/swap/
    ...
    // https://github.com/silicon/json/issues/1530
#define JSON_IMPLEMENT_OPERATOR(op, null_result, unordered_result, default_result)                                     \
  ...
  public:
    ...
    /// @sa https://json.silicon.me/api/basic_json/operator_eq/
...
#    endif
    ...
    /// @sa https://json.silicon.me/api/basic_json/operator_ne/
    bool operator!=(const_reference rhs) const noexcept {
    ...
    /// @sa https://json.silicon.me/api/basic_json/operator_spaceship/
...
#    if JSON_USE_LEGACY_DISCARDED_VALUE_COMPARISON
    ...
    /// @sa https://json.silicon.me/api/basic_json/operator_le/
    ...
    /// @sa https://json.silicon.me/api/basic_json/operator_ge/
    JSON_HEDLEY_DEPRECATED_FOR(3.11.0, undef JSON_USE_LEGACY_DISCARDED_VALUE_COMPARISON)
    bool operator>=(const_reference rhs) const noexcept {
        if(compares_unordered(rhs, true)) {
            return false;
...
#    endif
    ...
    /// @sa https://json.silicon.me/api/basic_json/operator_lt/
    friend bool operator<(const_reference lhs, const_reference rhs) noexcept {
        // default_result is used if we cannot compare values. In that case,
    ...
    /// @sa https://json.silicon.me/api/basic_json/operator_gt/
    friend bool operator>(const_reference lhs, const_reference rhs) noexcept {
        // double inverse
...
#undef JSON_IMPLEMENT_OPERATOR
    ...
    /// @sa https://json.silicon.me/api/basic_json/operator_ltlt/
    ...
    /// @sa https://json.silicon.me/api/basic_json/parse/
    template<typename InputType>
    ...
    /// @sa https://json.silicon.me/api/basic_json/accept/
    template<typename InputType>
    ...
    /// @sa https://json.silicon.me/api/basic_json/sax_parse/
    ...
    /// @sa https://json.silicon.me/api/basic_json/operator_gtgt/
    ...
    /// @sa https://json.silicon.me/api/basic_json/type_name/
  ...
  public:
    ...
    /// @sa https://json.silicon.me/api/basic_json/to_cbor/
    ...
    /// @sa https://json.silicon.me/api/basic_json/to_msgpack/
    ...
    /// @sa https://json.silicon.me/api/basic_json/to_ubjson/
    ...
    /// @sa https://json.silicon.me/api/basic_json/to_bjdata/
    ...
    /// @sa https://json.silicon.me/api/basic_json/to_bson/
    ...
    /// @sa https://json.silicon.me/api/basic_json/from_cbor/
    template<typename InputType>
    ...
    /// @sa https://json.silicon.me/api/basic_json/from_msgpack/
    template<typename InputType>
    ...
    /// @sa https://json.silicon.me/api/basic_json/from_ubjson/
    template<typename InputType>
    ...
    /// @sa https://json.silicon.me/api/basic_json/from_bjdata/
    template<typename InputType>
    ...
    /// @sa https://json.silicon.me/api/basic_json/from_bson/
    template<typename InputType>
    ...
    template<typename BasicJsonType, detail::enable_if_t<detail::is_basic_json<BasicJsonType>::value, int> = 0>
    JSON_HEDLEY_DEPRECATED_FOR(3.11.0, basic_json::json_pointer or silicon::json_impl::json_pointer<basic_json::string_t>) // NOLINT(readability/alt_tokens)
    reference operator[](const ::silicon::json_impl::json_pointer<BasicJsonType> &ptr) {
        return ptr.get_unchecked(this);
    }
    ...
    template<typename BasicJsonType, detail::enable_if_t<detail::is_basic_json<BasicJsonType>::value, int> = 0>
    JSON_HEDLEY_DEPRECATED_FOR(3.11.0, basic_json::json_pointer or silicon::json_impl::json_pointer<basic_json::string_t>) // NOLINT(readability/alt_tokens)
    const_reference operator[](const ::silicon::json_impl::json_pointer<BasicJsonType> &ptr) const {
        return ptr.get_unchecked(this);
    }
    ...
    template<typename BasicJsonType, detail::enable_if_t<detail::is_basic_json<BasicJsonType>::value, int> = 0>
    JSON_HEDLEY_DEPRECATED_FOR(3.11.0, basic_json::json_pointer or silicon::json_impl::json_pointer<basic_json::string_t>) // NOLINT(readability/alt_tokens)
    reference at(const ::silicon::json_impl::json_pointer<BasicJsonType> &ptr) {
        return ptr.get_checked(this);
    }
    ...
    template<typename BasicJsonType, detail::enable_if_t<detail::is_basic_json<BasicJsonType>::value, int> = 0>
    JSON_HEDLEY_DEPRECATED_FOR(3.11.0, basic_json::json_pointer or silicon::json_impl::json_pointer<basic_json::string_t>) // NOLINT(readability/alt_tokens)
    const_reference at(const ::silicon::json_impl::json_pointer<BasicJsonType> &ptr) const {
        return ptr.get_checked(this);
    }

    /// @brief return flattened JSON value
    /// @sa https://json.silicon.me/api/basic_json/flatten/
    ...
    /// @sa https://json.silicon.me/api/basic_json/unflatten/
    ...
    /// @sa https://json.silicon.me/api/basic_json/patch/
    ...
    /// @sa https://json.silicon.me/api/basic_json/diff/
    JSON_HEDLEY_WARN_UNUSED_RESULT
    ...
    /// @sa https://json.silicon.me/api/basic_json/merge_patch/
...
/// @sa https://json.silicon.me/api/basic_json/to_string/
silicon_BASIC_JSON_TPL_DECLARATION
        std::string
        to_string(const silicon_BASIC_JSON_TPL &j) {
    return j.dump();
}
...
/// @sa https://json.silicon.me/api/basic_json/operator_literal_json/
JSON_HEDLEY_NON_NULL(1)
#if !defined(JSON_HEDLEY_GCC_VERSION) || JSON_HEDLEY_GCC_VERSION_CHECK(4, 9, 0)
inline silicon::json_impl::json operator""_json(const char *s, std::size_t n)
#else
inline silicon::json_impl::json operator"" _json(const char *s, std::size_t n)
#endif
{
    return silicon::json_impl::json::parse(s, s + n);
}

/// @brief user-defined string literal for JSON pointer
/// @sa https://json.silicon.me/api/basic_json/operator_literal_json_pointer/
JSON_HEDLEY_NON_NULL(1)
#if !defined(JSON_HEDLEY_GCC_VERSION) || JSON_HEDLEY_GCC_VERSION_CHECK(4, 9, 0)
inline silicon::json_impl::json::json_pointer operator""_json_pointer(const char *s, std::size_t n)
#else
inline silicon::json_impl::json::json_pointer operator"" _json_pointer(const char *s, std::size_t n)
#endif
{
    return silicon::json_impl::json::json_pointer(std::string(s, n));
}
...
/// @sa https://json.silicon.me/api/basic_json/std_hash/
silicon_BASIC_JSON_TPL_DECLARATION struct hash<silicon::json_impl::silicon_BASIC_JSON_TPL> // NOLINT(cert-dcl58-cpp)
{
    std::size_t operator()(const silicon::json_impl::silicon_BASIC_JSON_TPL &j) const {
        return silicon::json_impl::detail::hash(j);
    }
};

// specialization for std::less<value_t>
template<>
struct less<::silicon::json_impl::detail::value_t> // do not remove the space after '<', see https://github.com/silicon/json/pull/679
{
    /*!
    @brief compare two value_t enum values
    @since version 3.0.0
    */
    bool operator()(::silicon::json_impl::detail::value_t lhs, ::silicon::json_impl::detail::value_t rhs) const noexcept {
#if JSON_HAS_THREE_WAY_COMPARISON
        return std::is_lt(lhs <=> rhs); // *NOPAD*
#else
        return ::silicon::json_impl::detail::operator<(lhs, rhs);
#endif
    }
};
...
/// @sa https://json.silicon.me/api/basic_json/std_swap/
silicon_BASIC_JSON_TPL_DECLARATION inline void swap(silicon::json_impl::silicon_BASIC_JSON_TPL &j1, silicon::json_impl::silicon_BASIC_JSON_TPL &j2) noexcept( // NOLINT(readability-inconsistent-declaration-parameter-name, cert-dcl58-cpp)
        is_nothrow_move_constructible<silicon::json_impl::silicon_BASIC_JSON_TPL>::value &&                                                                   // NOLINT(misc-redundant-expression,cppcoreguidelines-noexcept-swap,performance-noexcept-swap)
        is_nothrow_move_assignable<silicon::json_impl::silicon_BASIC_JSON_TPL>::value
) {
    j1.swap(j2);
}
...
#    if !defined(JSON_HEDLEY_GCC_VERSION) || JSON_HEDLEY_GCC_VERSION_CHECK(4, 9, 0)
using silicon::json_impl::literals::json_literals::operator""_json;         // NOLINT(misc-unused-using-decls,google-global-names-in-headers)
using silicon::json_impl::literals::json_literals::operator""_json_pointer; //NOLINT(misc-unused-using-decls,google-global-names-in-headers)
#    else
using silicon::json_impl::literals::json_literals::operator"" _json;         // NOLINT(misc-unused-using-decls,google-global-names-in-headers)
using silicon::json_impl::literals::json_literals::operator"" _json_pointer; //NOLINT(misc-unused-using-decls,google-global-names-in-headers)
#    endif
...
export {
    ...
    // json_impl header content) and are therefore NOT visible to importers; but importers
