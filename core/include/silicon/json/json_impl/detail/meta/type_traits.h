...
#include <silicon/json/json_impl/detail/iterators/iterator_traits.h>
#include <silicon/json/json_impl/detail/macro_scope.h>
#include <silicon/json/json_impl/detail/meta/call_std/begin.h>
#include <silicon/json/json_impl/detail/meta/call_std/end.h>
...
silicon_BASIC_JSON_TPL_DECLARATION struct is_basic_json<silicon_BASIC_JSON_TPL>: std::true_type {};
...
template<typename T>
using is_json_pointer = is_specialization_of<::silicon::json_impl::json_pointer, uncvref_t<T>>;
