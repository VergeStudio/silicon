...
// And see https://github.com/silicon/json/pull/1391
template<std::size_t N, typename IteratorType, enable_if_t<N == 0, int> = 0>
auto get(const silicon::json_impl::detail::iteration_proxy_value<IteratorType> &i) -> decltype(i.key()) {
    return i.key();
}
// Structured Bindings Support
// For further reference see https://blog.tartanllama.xyz/structured-bindings/
...
auto get(const silicon::json_impl::detail::iteration_proxy_value<IteratorType> &i) -> decltype(i.value()) {
    return i.value();
}
...
// Fix: https://github.com/silicon/json/issues/1401
#    pragma clang diagnostic push
#    pragma clang diagnostic ignored "-Wmismatched-tags"
#endif
template<typename IteratorType>
class tuple_size<::silicon::json_impl::detail::iteration_proxy_value<IteratorType>> // NOLINT(cert-dcl58-cpp)
    : public std::integral_constant<std::size_t, 2> {};

template<std::size_t N, typename IteratorType>
class tuple_element<N, ::silicon::json_impl::detail::iteration_proxy_value<IteratorType>> // NOLINT(cert-dcl58-cpp)
{
  public:
    using type = decltype(get<N>(std::declval<
                                 ::silicon::json_impl::detail::iteration_proxy_value<IteratorType>>()));
};
#if defined(__clang__)
...
#if JSON_HAS_RANGES
template<typename IteratorType>
inline constexpr bool ::std::ranges::enable_borrowed_range<::silicon::json_impl::detail::iteration_proxy<IteratorType>> = true;
#endif
