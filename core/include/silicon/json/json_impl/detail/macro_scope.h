...
#include <silicon/json/json_impl/detail/meta/detected.h>
#include <silicon/json/json_impl/thirdparty/hedley/hedley.h>
#include <utility> // declval, pair

// This file contains all internal macro definitions (except those affecting ABI)
// You MUST include macro_unscope.h at the end of json_impl.cppm to undef all of them
...
#define silicon_DEFINE_TYPE_INTRUSIVE(Type, ...)                                                                                                                        \
    friend void to_json(silicon::json_impl::json &silicon_json_j, const Type &silicon_json_t) { SILICON_JSON_EXPAND(SILICON_JSON_PASTE(SILICON_JSON_TO, __VA_ARGS__)) } \
    friend void from_json(const silicon::json_impl::json &silicon_json_j, Type &silicon_json_t) { SILICON_JSON_EXPAND(SILICON_JSON_PASTE(SILICON_JSON_FROM, __VA_ARGS__)) }

#define silicon_DEFINE_TYPE_INTRUSIVE_WITH_DEFAULT(Type, ...)                                                                                                           \
    friend void to_json(silicon::json_impl::json &silicon_json_j, const Type &silicon_json_t) { SILICON_JSON_EXPAND(SILICON_JSON_PASTE(SILICON_JSON_TO, __VA_ARGS__)) } \
    friend void from_json(const silicon::json_impl::json &silicon_json_j, Type &silicon_json_t) {                                                                       \
...
#define silicon_DEFINE_TYPE_NON_INTRUSIVE(Type, ...)                                                                                                                    \
    inline void to_json(silicon::json_impl::json &silicon_json_j, const Type &silicon_json_t) { SILICON_JSON_EXPAND(SILICON_JSON_PASTE(SILICON_JSON_TO, __VA_ARGS__)) } \
    inline void from_json(const silicon::json_impl::json &silicon_json_j, Type &silicon_json_t) { SILICON_JSON_EXPAND(SILICON_JSON_PASTE(SILICON_JSON_FROM, __VA_ARGS__)) }
...
#define silicon_DEFINE_TYPE_NON_INTRUSIVE_WITH_DEFAULT(Type, ...)                                                                                                       \
    inline void to_json(silicon::json_impl::json &silicon_json_j, const Type &silicon_json_t) { SILICON_JSON_EXPAND(SILICON_JSON_PASTE(SILICON_JSON_TO, __VA_ARGS__)) } \
    inline void from_json(const silicon::json_impl::json &silicon_json_j, Type &silicon_json_t) {                                                                       \
        const Type silicon_json_default_obj{};                                                                                                                          \
        SILICON_JSON_EXPAND(SILICON_JSON_PASTE(SILICON_JSON_FROM_WITH_DEFAULT, __VA_ARGS__))                                                                            \
    }
...
#define silicon_CAN_CALL_STD_FUNC_IMPL(std_name)                                      \
    ...
    struct would_call_std_##std_name {                                                \
        static constexpr auto const value = ::silicon::json_impl::detail::            \
