...
int main (void)
{
  ...
  ts_type.size = 0;
  ts_type.alignment = 0;
  ts_type.type = SFFI_TYPE_STRUCT;
  ts_type.elements = ts_type_elements;
  ts_type_elements[0] = &sffi_type_ulong;
  ts_type_elements[1] = &sffi_type_float;
  ...
  sffi_call(&cif, SFFI_FN(struct_int_float), &rfloat, values);
