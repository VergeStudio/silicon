...
static void
cls_struct_116byte_gn(sffi_cif* cif __UNUSED__, void* resp, void** args, void* userdata __UNUSED__)
{
...
int main (void)
{
	...
	void* args_dbl[5];
	sffi_type* cls_struct_fields[16];
	...
	cls_struct_fields[13] = &sffi_type_double;
	cls_struct_fields[14] = &sffi_type_sint32;
