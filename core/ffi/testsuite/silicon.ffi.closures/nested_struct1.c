...
static void
cls_struct_combined_gn(sffi_cif* cif __UNUSED__, void* resp, void** args,
...
int main (void)
{
  ...
  void* args_dbl[5];
  sffi_type* cls_struct_fields[5];
  sffi_type* cls_struct_fields1[5];
  sffi_type* cls_struct_fields2[5];
  ...
  cls_struct_fields1[0] = &sffi_type_sint;
  cls_struct_fields1[1] = &sffi_type_double;
  cls_struct_fields1[2] = &sffi_type_float;
  ...
  CHECK(sffi_prep_cif(&cif, SFFI_DEFAULT_ABI, 4, &cls_struct_type2,
